...
<div align="left">
    <p>
        jit-lang is the CODE-tier crate: Lowers IR to machine code in executable memory via Cranelift and runs it immediately. Part of the -lang language-construction family; see _strategy/LANG_COLLECTION.md for the master plan.
    </p>
    <br>
    <hr>
    <p>
